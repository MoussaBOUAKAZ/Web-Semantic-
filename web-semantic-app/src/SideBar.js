...
function SideBar({ classes, showQueryStructure }) {
  ...
  WHERE { 
    ...
    },
    {
      ...
      query: `INSERT { 
    ?s <http://example.com/age> 30 
  } 
  WHERE { 
    ?s a <http://example.com/Person> 
  }`,
    },
    {
      IconLink: "insertIcon.png",
      ...
      query: `DELETE { 
    ?s <http://example.com/age> 25 
  } 
  INSERT { 
    ?s <http://example.com/age> 26 
  } 
  WHERE { 
    ?s <http://example.com/age> 25 
  }`,
  ...
  WHERE { 
    ...
    UNION 
    { 
      ?s <http://example.com/type> <http://example.com/Organization> 
    } 
  }`,
    },
    {
      ...
      Label: "BIND Query",
      query: `SELECT ?s ?ageInDays 
  WHERE { 
    ?s 'URI' ?age 
    BIND(?age * 365 AS ?ageInDays) 
  }`,
    },
    {
